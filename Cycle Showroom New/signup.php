...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $sql_check_username = "SELECT * FROM `customer` WHERE `c_username`='$username'";
    $result_check_username = mysqli_query($conn, $sql_check_username);
    if(mysqli_num_rows($result_check_username) > 0) {
        $exists = true;
    }

    if(($password == $cpassword) && !$exists && ($username != 'admin')){
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container my-4">
        ...
        <form action="/Cycle Showroom/signup.php" method="post" style="display: flex; flex-direction: column; align-items:center; padding:15px">
