            ...
            <div class="col-md-4">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body my-2">
                        <h5 class="card-title">View and Book Cycles</h5>
                        <p class="card-text">View the cycles available and book them.</p>
                        <a href="view_bookcycle.php" class="btn btn-primary">View/Book Cycles</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body my-2">
                        ...
                        <p class="card-text">View the cycle bookings done by you.</p>
